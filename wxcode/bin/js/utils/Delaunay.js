...
var Delaunay = /** @class */ (function () {
    ...
    Delaunay.supertriangle = function (vertices) {
    ...
    Delaunay.circumcircle = function (vertices, i, j, k) {
        ...
        if (fabsy1y2 < Delaunay.EPSILON && fabsy2y3 < Delaunay.EPSILON)
    ...
    Delaunay.triangulate = function (vertices, key) {
            ...
            * it's edges to an edge list. */
            for (j = open.length; j--;) {
                ...
                * from the open list, add it to the closed list, and skip. */
                ...
                if (dx * dx + dy * dy - open[j].r > Delaunay.EPSILON)
                    continue;
    ...
    Delaunay.contains = function (tri, p) {
