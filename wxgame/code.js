...
var APP_ENAME = '';
var APPID = '	';
var BASE_URL = "https://www.webuzz.com.cn";
//云开发id
var ENV_ID = "";
...
//微信解密接口
var WXINFOPATH = 'https://www.webuzz.com.cn/game/wx/getWxInfo.do';
var APPNAME = 'AniHexaPuzzle';
//每个level题目数量
...
var QUES = [];
var ifIphoneX = false;
var QINIU_ICON_PATH = "https://qiniu.webuzz.com.cn/gameIcon/";
...
(function (ui) {
    var dialog_dir;
    (function (dialog_dir) {
        var dialogAppListUI = /** @class */ (function (_super) {
            __extends(dialogAppListUI, _super);
            function dialogAppListUI() {
                return _super.call(this) || this;
            }
            dialogAppListUI.prototype.createChildren = function () {
                View.regComponent("ImageRunTime", ImageRunTime);
                _super.prototype.createChildren.call(this);
                this.createView(ui.dialog_dir.dialogAppListUI.uiView);
            };
            dialogAppListUI.uiView = { "type": "Dialog", "props": { "width": 1080, "height": 1900 }, "child": [{ "type": "Sprite", "props": { "y": 0, "x": 0, "width": 1080, "var": "maskView", "height": 1900 } }, { "type": "Image", "props": { "y": 0, "x": 0, "width": 1080, "visible": false, "var": "bgImg", "skin": "comp/bg.png", "height": 1900 } }, { "type": "Label", "props": { "y": 20, "x": 0, "width": 1080, "var": "titleLabel", "text": "热门推荐", "height": 100, "fontSize": 90, "font": "SimHei", "color": "#eeee0f", "align": "center" } }, { "type": "Image", "props": { "y": 140, "x": 940, "width": 120, "visible": false, "var": "btnClose", "skin": "subassets/comp/imgClose.png", "runtime": "ImageRunTime", "height": 135, "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "View", "props": { "y": 120, "x": 110, "width": 860, "visible": true, "var": "appList", "height": 1550 } }, { "type": "Button", "props": { "y": 1680, "width": 300, "var": "btnContinue", "height": 80, "centerX": 0 }, "child": [{ "type": "Label", "props": { "y": 0, "x": 0, "width": 300, "underline": true, "text": "继续游戏", "height": 80, "fontSize": 66, "color": "#c9e215", "bold": true, "align": "center" } }] }] };
            return dialogAppListUI;
        }(Dialog));
        dialog_dir.dialogAppListUI = dialogAppListUI;
    })(dialog_dir = ui.dialog_dir || (ui.dialog_dir = {}));
})(ui || (ui = {}));
(function (ui) {
    var dialog_dir;
    (function (dialog_dir) {
        var dialogAppList1UI = /** @class */ (function (_super) {
            __extends(dialogAppList1UI, _super);
            function dialogAppList1UI() {
                return _super.call(this) || this;
            }
            dialogAppList1UI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.dialog_dir.dialogAppList1UI.uiView);
            };
            dialogAppList1UI.uiView = { "type": "Dialog", "props": { "width": 1080, "height": 1920 }, "child": [{ "type": "Sprite", "props": { "y": 0, "x": 0, "width": 1080, "var": "maskView", "height": 1920 } }, { "type": "Label", "props": { "y": 40, "width": 1080, "var": "titleLabel", "text": "大家都在玩", "height": 80, "fontSize": 64, "font": "SimHei", "color": "#eeee0f", "centerX": 0, "align": "center" } }, { "type": "View", "props": { "y": 430, "x": 0, "width": 1080, "visible": true, "var": "appList", "height": 1240 } }, { "type": "Button", "props": { "y": 1680, "width": 300, "var": "btnContinue", "height": 80, "centerX": 0 }, "child": [{ "type": "Label", "props": { "y": 0, "x": 0, "width": 300, "underline": true, "text": "继续游戏", "height": 80, "fontSize": 66, "color": "#c9e215", "bold": true, "align": "center" } }] }, { "type": "Sprite", "props": { "y": 120, "x": 0, "width": 1080, "var": "topNavView", "height": 270 }, "child": [{ "type": "Sprite", "props": { "y": 0, "x": 0, "width": 1080, "var": "topMask", "height": 270, "alpha": 1 }, "child": [{ "type": "Rect", "props": { "y": 0, "x": 0, "width": 1080, "lineWidth": 1, "height": 270, "fillColor": "#0f0101" } }] }, { "type": "List", "props": { "y": 0, "x": 0, "width": 1080, "var": "topList", "spaceY": 0, "spaceX": 0, "repeatY": 1, "repeatX": 4, "height": 270 } }] }] };
            return dialogAppList1UI;
        }(Dialog));
        dialog_dir.dialogAppList1UI = dialogAppList1UI;
    })(dialog_dir = ui.dialog_dir || (ui.dialog_dir = {}));
})(ui || (ui = {}));
(function (ui) {
    var dialog_dir;
    (function (dialog_dir) {
        var DialogLoginUI = /** @class */ (function (_super) {
            __extends(DialogLoginUI, _super);
            function DialogLoginUI() {
                return _super.call(this) || this;
            }
            DialogLoginUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.dialog_dir.DialogLoginUI.uiView);
            };
            DialogLoginUI.uiView = { "type": "Dialog", "props": { "x": 0, "width": 1000, "height": 2000 }, "child": [{ "type": "Image", "props": { "y": 360, "x": 15, "width": 970, "var": "navListLayout", "skin": "comp/passPopupBg.png", "height": 1000, "sizeGrid": "30,30,30,30" }, "child": [{ "type": "Label", "props": { "y": 16, "width": 900, "var": "titleLabel", "text": "好友都在玩", "height": 100, "fontSize": 80, "font": "SimHei", "color": "#252522", "centerX": 0, "align": "center" } }, { "type": "List", "props": { "y": 135, "x": 15, "width": 940, "var": "navList", "spaceY": 30, "spaceX": 20, "repeatY": 2, "repeatX": 3, "height": 730 } }, { "type": "Button", "props": { "y": 890, "x": 285, "width": 400, "var": "btnNext", "height": 80, "centerX": 0 }, "child": [{ "type": "Label", "props": { "y": 0, "x": 0, "width": 400, "valign": "middle", "underline": true, "text": "开始游戏", "height": 80, "fontSize": 72, "color": "#ff0400", "bold": true, "align": "center" } }] }] }] };
            return DialogLoginUI;
        }(Dialog));
        dialog_dir.DialogLoginUI = DialogLoginUI;
    })(dialog_dir = ui.dialog_dir || (ui.dialog_dir = {}));
})(ui || (ui = {}));
(function (ui) {
    var dialog_dir;
...
//点的大小
var DOT_SCALE = 0.3;
var LINE_WIDTH = DOT_SCALE * 1.09;
var penPath = "subassets/comp/Spot.png";
var PEN_MOVE_TIME = 300;
...
function calcBoxSize(father, rows, cols) {
    var w = father.width / cols;
    var h = father.height / rows;
    return Math.min(w, h);
}
function calcBaseXY(father, rows, cols) {
    var size = calcBoxSize(father, rows, cols);
    var left = (father.width - cols * size) / 2;
    var top = (father.height - rows * size) / 2;
    return {
        x: left, y: top
    };
}
function createDot(blockSize) {
    // let dot: Laya.Sprite = Laya.Pool.getItemByClass("DOTImg", Laya.Sprite);
    var dot = new Laya.Sprite();
    dot.size(blockSize, blockSize);
    dot.visible = true;
    var dotImg = null;
    if (dot.numChildren == 0) {
        dotImg = new Laya.Image();
        dotImg.anchorX = 0.5;
        dotImg.anchorY = 0.5;
        dotImg.skin = "subassets/comp/imgDrawDot.png";
        dot.addChild(dotImg);
    }
    else {
        dotImg = dot.getChildAt(0);
        dotImg.skin = "subassets/comp/imgDrawDot.png";
    }
    dotImg.size(blockSize * DOT_SCALE, blockSize * DOT_SCALE);
    dotImg.pos(blockSize / 2, blockSize / 2);
    dot.pivot(blockSize / 2, blockSize / 2);
    /*   dot.on(Laya.Event.REMOVED, dot, function () {
           Laya.Pool.recover("DOTImg", dot);
       });*/
    return dot;
}
...
//获取移动方向
function getTurnAngle(p1, p2) {
    //判断是否是斜角
    var turnAngle = getPointAngle({ x: p1.x, y: p1.y }, { x: p2.x, y: p2.y });
    // log("转角：" + turnAngle);
    var moveDirection = MOVE_ARROW.NONE;
    if (turnAngle <= 90) {
        //右下角
        if (turnAngle < 20) {
            moveDirection = MOVE_ARROW.RIGHT;
            // log("向右移动");
        }
        else if (turnAngle > 70) {
            moveDirection = MOVE_ARROW.DOWN;
            // log("向下移动");
        }
        else {
            moveDirection = MOVE_ARROW.RIGHT_DOWN;
            // log("向右下移动");
        }
    }
        ...
        if (turnAngle < 110) {
            ...
            moveDirection = MOVE_ARROW.LEFT;
            // log("向左移动");
        }
        else {
            moveDirection = MOVE_ARROW.LEFT_DOWN;
            // log("向左下移动");
        }
    }
        ...
        else if (turnAngle > 250) {
            moveDirection = MOVE_ARROW.UP;
            // log("向上移动");
        }
        else {
            moveDirection = MOVE_ARROW.LEFT_UP;
            // log("向左上移动");
        }
    }
    else {
        ...
        else if (turnAngle > 340) {
            moveDirection = MOVE_ARROW.RIGHT;
            // log("向右移动");
        }
        else {
            moveDirection = MOVE_ARROW.RIGHT_UP;
            // log("向右上移动");
        }
    }
...
var GameUI = /** @class */ (function (_super) {
    ...
    function GameUI() {
        ...
        _this.level = 0;
        //================end=================
        _this.bottomView1 = null;
        _this.bottomView2 = null;
        _this.bottomView3 = null;
        _this.bottomView4 = null;
        _this.bottomView5 = null;
        gameUiSelf = _this;
        ...
        if (game.WAITING_APP_ARRAY != null && game.WAITING_APP_ARRAY.length > 0) {
            ...
            if ((this.btnTipLayout.y + this.btnTipLayout.height) < (SCREENHEIGHT - this.bottomApp.height - (ifIphoneX ? 50 : 0))) {
                ...
                if (bottomType == 1) {
                    ...
                    this.bottomView1 = new NavigationBottomView1(bottomItemArray);
                    this.bottomView1.pos(0, 0);
                    this.bottomAppList.addChild(this.bottomView1);
                }
                    ...
                    this.bottomView2 = new NavigationBottomView2(bottomItemArray);
                    this.bottomView2.pos(0, 0);
                    // }
                    this.bottomAppList.addChild(this.bottomView2);
                }
                    ...
                    if (!this.bottomView3) {
                        ...
                        this.bottomView3 = new NavigationBottomView3(bottomItemArray);
                        this.bottomView3.pos(0, 0);
                    }
                    this.bottomAppList.addChild(this.bottomView3);
                }
                    ...
                    this.bottomView4 = new NavigationBottomView4(bottomItemArray);
                    this.bottomView4.pos(0, 5);
                    // }
                    this.bottomAppList.addChild(this.bottomView4);
                }
                    ...
                    if (!this.bottomView5) {
                        ...
                        var bottomView = new NavigationBottomView5(bottomItemArray);
                        bottomView.pos(0, 0);
                        this.bottomView5 = bottomView;
                    }
                    this.bottomAppList.addChild(this.bottomView5);
                }
    ...
    GameUI.prototype.showTopAppList = function () {
        if (game.WAITING_APP_ARRAY != null && game.WAITING_APP_ARRAY.length > 0) {
            log('展示顶部导量');
            // this.topList.removeChildren();
            this.topList.itemRender = NaviTopItem;
            this.topList.hScrollBarSkin = "";
            this.topList.renderHandler = new Laya.Handler(this, this.renderListHandler);
            var bottomItemArray = [];
            for (var i = 0; i < game.WAITING_APP_ARRAY.length; i++) {
...
var PassPage = /** @class */ (function (_super) {
    ...
    PassPage.prototype.setBannerNaviView = function () {
        var that = this;
        if (game.passBottomModel < 0) {
            //什么都不显示
            wxUtils.hideBanner();
            Laya.Tween.to(this.btnNext, { scaleX: 1, scaleY: 1 }, game.passBtnDelay, Laya.Ease.linearNone);
        }
        else {
            if (game.passBannerDelay >= 0) {
                // banner覆盖，显示顶部导量
                this.btnNext.y = 1584;
                this.contentLayout.height = 1400;
                this.setTopAppList();
                Laya.Tween.to(this.btnNext, { scaleX: 1, scaleY: 1 }, game.passBtnDelay, Laya.Ease.linearNone);
                if (game.nextChangeTime > 0) {
                    Laya.timer.loop(game.nextChangeTime, this, this.setTopAppList);
                }
            }
    ...
    PassPage.prototype.setBottomAppList = function () {
        ...
        game.updateWaitingNavAppList();
        if (game.WAITING_APP_ARRAY != null && game.WAITING_APP_ARRAY.length > 0) {
            var rowNum = Math.min(1, Math.ceil(game.WAITING_APP_ARRAY.length / 5));
            var bottomHeight = 200 * rowNum + 10;
            this.bottomApp.height = bottomHeight;
            this.bottomAppList.height = bottomHeight - 20;
            rN = 5 * rowNum;
            // log('底部行数=' + rowNum)
            var heightCon = (this.contentLayout.y + this.contentLayout.height) < (SCREENHEIGHT - this.bottomApp.height - (ifIphoneX ? 50 : 0));
            if ((rowNum > 0) && heightCon) {
                //底部空间放得下
                this.bottomApp.y = SCREENHEIGHT - this.bottomApp.height - (ifIphoneX ? 50 : 0);
                this.bottomAppBg.height = this.bottomApp.height;
                //添加item
                this.bottomAppList.destroyChildren();
                var drawerArr = [];
                for (var index = 0; index < game.WAITING_APP_ARRAY.length; index++) {
                    drawerArr.push(index);
                }
                var tmpArr = [];
                if (drawerArr.length <= rN) {
                    tmpArr = drawerArr;
                }
                else {
                    while (tmpArr.length < rN) {
                        var ta = Math.floor(Math.random() * drawerArr.length);
                        tmpArr.push(drawerArr[ta]);
                        drawerArr.splice(ta, 1);
                    }
                ...
                var bH = 200;
                for (var index = 0; index < tmpArr.length; index++) {
                    var iapp = game.WAITING_APP_ARRAY[tmpArr[index]];
                    var iapp1 = JSON.parse(JSON.stringify(iapp));
                    iapp1["bottom"] = "pass-5";
                    var item = Laya.Pool.getItemByClass("DrawerItem", DrawerItem);
                    //计算位置
                    var iy = Math.floor(index / 5) * bH + 90;
                    var ix = Math.floor(index % 5) * bW + 140;
                    item.pos(ix, iy);
                    item.setData(iapp1, true);
                    this.bottomAppList.addChild(item);
                }
                this.bottomApp.visible = true;
                wxUtils.aldSendEventFunc('出现底部导量', { 'from': "pass-5" + "-R=" + rowNum });
                // this.scaleAniLoop();
                // Laya.timer.loop(1200, this, this.scaleAniLoop);
            }
        }
    };
    //设置顶部导量矩阵
    PassPage.prototype.setTopAppList = function () {
        //更新待跳转列表
        game.updateWaitingNavAppList();
        // log('waiting app:'); log(game.WAITING_APP_ARRAY);
        if (game.WAITING_APP_ARRAY != null && game.WAITING_APP_ARRAY.length > 0) {
            var rowNum = Math.min(2, Math.ceil(game.WAITING_APP_ARRAY.length / 3));
            rN = 3 * rowNum;
            if (rowNum > 0) {
                //添加item
                this.topAppList.destroyChildren();
                var bW = 330;
                var bH = 330;
                var tmpN = game.passLevelsN;
                if (tmpN <= game.goodIconLevel) {
                    // 指定显示吸量icon
                    var tmpArr = [];
                    var startIndex = 6 * (tmpN - 1);
                    while (tmpArr.length < rN && startIndex < game.goodIconList.length) {
                        var gskin = game.goodIconList[startIndex];
                        for (var i = 0; i < game.WAITING_APP_ARRAY.length; i++) {
                            if (game.WAITING_APP_ARRAY[i].skin == gskin) {
                                tmpArr.push(i); //找到对应app
                                break;
                            }
                        }
                        startIndex++;
                    ...
                    log(tmpArr);
                    while (tmpArr.length < rN) {
                        var tidx = Math.floor(game.WAITING_APP_ARRAY.length * Math.random());
                        tmpArr.push(tidx);
                    }
                    for (var index = 0; index < tmpArr.length; index++) {
                        var iapp = game.WAITING_APP_ARRAY[tmpArr[index]];
                        var iapp1 = JSON.parse(JSON.stringify(iapp));
                        iapp1["bottom"] = "pass-top";
                        var item = Laya.Pool.getItemByClass("DrawerItemBig2", DrawerItemBig2);
                        //计算位置
                        var iy = Math.floor(index / 3) * bH + 170;
                        var ix = Math.floor(index % 3) * bW + 210;
                        item.pos(ix, iy);
                        item.setData(iapp1, true);
                        this.topAppList.addChild(item);
                    }
                }
                else {
                    // 随机选择6款
                    ...
                    if (drawerArr.length <= rN) {
                        ...
                        while (tmpArr.length < rN && drawerArr.length > 0) {
                            var ta = Math.floor(Math.random() * drawerArr.length);
                            var tid = game.WAITING_APP_ARRAY[drawerArr[ta]].appid;
                            if (tmpAppid.indexOf(tid) == -1) {
                                tmpArr.push(drawerArr[ta]);
                                tmpAppid.push(tid);
                            }
                            drawerArr.splice(ta, 1);
                ...
                this.topApp.visible = true;
                wxUtils.aldSendEventFunc('过关页顶部导量', { 'from': "pass-top" + "-R=" + rowNum });
            }
        }
    };
    ...
    LoadPage.prototype.loadRes = function (callBack) {
        ...
        var loadTask = wx.loadSubpackage({
            ...
            success: function (res) {
                ...
                //将题目数组赋值给question
                questions = window["game_level_array"];
                allQuestionLen = questions.length;
            },
            fail: function (res) {
                // 分包加载失败通过 fail 回调
    ...
    Game.prototype.showLogin = function () {
        if (isLoadSubpackages && ifGotVersionSet) {
            if (game.loginIconList.length > 0 && game.specChannelList.length > 0 && userScene == 1037 && game.specChannelList.indexOf(userChannel) > -1) {
                ...
                var ifShowNavi = (ifNaviCheckArea == false) || (ifNaviCheckArea && areaCon);
                if (ifShowNavi && bottomItemArray.length > 3) {
